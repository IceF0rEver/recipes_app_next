...
import type { SettingsPageProps } from "@/app/[locale]/dashboard/settings/_components/_types/settings-type";
import {
	SidebarContent,
	SidebarGroup,
	SidebarGroupContent,
...
export default function SettingsPage({ userWithSubscription }: SettingsPageProps) {
	const t = useI18n();
	...
	const items = useMemo(
		() => [
			...
			},
			{
				...
				key: "plan",
				component: <Plan userWithSubscription={userWithSubscription} />,
			},
		],
		[t, userWithSubscription],
	);
